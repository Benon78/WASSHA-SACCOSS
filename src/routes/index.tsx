  ...
  head: () => ({
    meta: [
      { title: "WASSHA SACCOS — Modern Savings & Loans Platform" },
      {
        name: "description",
        content:
          "Secure SACCOS management for members, approvers, managers, and admins. Transparent loans, real-time notifications, fintech-grade UX.",
      },
      { property: "og:title", content: "WASSHA SACCOS — Modern Savings & Loans Platform" },
      {
        property: "og:description",
        content: "Transparent loans, member self-service, secure approvals.",
      },
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(60% 50% at 80% 0%, oklch(0.78 0.17 60 / 0.4), transparent 60%)",
          }}
        />
        <div className="container mx-auto px-4 py-20 md:py-28">
          <div className="mx-auto max-w-3xl text-center text-white">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-base text-primary/90 md:text-lg [text-shadow:0_1px_8px_rgb(0_0_0_/_0.5)]">
              Transparent savings, intelligent loan workflows, and real-time notifications — purpose
              built for WASSHA SACCOS members, approvers, and administrators.
            </p>
            <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
              ...
              >
                <Link to="/dashboard">
                  Explore Member Dashboard <ArrowRight className="ml-1.5 h-4 w-4" />
                </Link>
              </Button>
              <Button
                size="lg"
                asChild
                variant="outline"
                className="border-white bg-slate-900/70 text-white hover:bg-slate-900/90 hover:text-white"
              >
            ...
            <div className="mt-10 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs font-medium text-primary [text-shadow:0_1px_6px_rgb(0_0_0_/_0.5)]">
              ...
              <span className="inline-flex items-center gap-1.5">
                <ShieldCheck className="h-3.5 w-3.5" /> Role-based access
              </span>
              <span className="inline-flex items-center gap-1.5">
      ...
      <section id="features" className="container mx-auto px-4 py-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-2 text-3xl font-bold tracking-tight md:text-4xl">
            Everything a modern SACCOS needs
          </h2>
          <p className="mt-3 text-muted-foreground">
            From member self-service to multi-stage loan approvals and audit-grade reporting.
          </p>
        </div>
          ...
          {[
            {
              ...
              desc: "Real-time balances, statements, and deposit notifications.",
            },
            {
              icon: TrendingUp,
              title: "Smart loan eligibility",
              desc: "Auto-calculated borrowing limits based on savings & debt ratio.",
            },
            {
              icon: ShieldCheck,
              title: "Secure approvals",
              desc: "Multi-stage workflow with comments and audit trail.",
            },
            {
              icon: Bell,
              title: "Real-time notifications",
              desc: "Email, in-app, and SMS-ready reminders for every event.",
            },
            {
              icon: FileBarChart,
              title: "Reports & analytics",
              desc: "Export PDF, Excel, CSV. Track defaulters, growth, and risk.",
            },
            {
              icon: Users,
              title: "Role-based dashboards",
              desc: "Tailored experiences for members, approvers, and admins.",
            },
          ].map((f) => (
            <div
              key={f.title}
              className="group rounded-2xl border border-border/70 bg-card p-6 shadow-[var(--shadow-card)] transition hover:-translate-y-1 hover:border-primary/30 hover:shadow-[var(--shadow-elegant)]"
            >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-12 grid grid-cols-1 gap-5 md:grid-cols-3">
            {[
              {
                title: "Members",
                desc: "Apply for loans, track balances, view repayment schedules, and download statements.",
                points: ["Loan eligibility", "Repayment tracking", "Statements"],
              },
              {
                title: "Approvers & Managers",
                desc: "Review queues, approve or forward loans, and analyze portfolio performance.",
                points: ["Approval queue", "Risk insights", "Personal loans"],
              },
              {
                title: "Administrators",
                desc: "Manage users, policies, interest rates, audit logs, and generate reports.",
                points: ["Roles & policies", "Audit logs", "Exports"],
              },
            ].map((r, i) => (
              <div
                key={r.title}
                className="relative overflow-hidden rounded-2xl border border-border/70 bg-card p-6 shadow-[var(--shadow-card)]"
              >
        ...
        <div className="overflow-hidden rounded-3xl border border-border/70 bg-card p-8 shadow-[var(--shadow-card)] md:p-12">
          <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold tracking-tight md:text-4xl">
                Total transparency, every stage of the way.
              </h2>
              <p className="mt-3 text-muted-foreground">
                Members watch their loan move through Submitted → Review → Branch → Finance →
                Manager → Disbursement in real time, with comments and ETAs at every step.
              </p>
            ...
            <div className="rounded-2xl bg-secondary/[0.04] p-6">
              ...
              <div className="mt-4 space-y-3">
                {["Submitted", "Branch Approval", "Finance Approval", "Manager Approval"].map(
                  (s, i) => (
                    <div key={s} className="flex items-center gap-3 text-sm">
                      <span
                        className={`flex h-6 w-6 items-center justify-center rounded-full text-[11px] font-bold ${i < 2 ? "bg-success text-success-foreground" : i === 2 ? "bg-[image:var(--gradient-primary)] text-primary-foreground" : "bg-muted text-muted-foreground"}`}
                      >
                        {i < 2 ? "✓" : i + 1}
                      </span>
                      <span
