...
export function AppHeader() {
  ...
  const primaryLinks = user ? (
    <>
      <Link
        to="/dashboard"
        className="transition hover:text-foreground whitespace-nowrap"
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        <DropdownMenuItem asChild>
          <Link to="/admin">{t("nav_admin")} home</Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/admin/board">{t("nav_board")}</Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/admin/policies">{t("nav_policies")}</Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/admin/reports">{t("nav_reports")}</Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/admin/audit">{t("nav_audit")}</Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/admin/escalations">Escalations queue</Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/admin/sla">SLA tracking</Link>
        </DropdownMenuItem>
        <DropdownMenuItem asChild>
          <Link to="/admin/import">Bulk member import</Link>
        </DropdownMenuItem>
        {isSuperAdmin && (
          <DropdownMenuItem asChild>
  ...
  const mobileNavLinks = user ? (
    <>
      ...
      {isAdmin && (
        <>
          <div className="mt-2 border-t pt-2 text-xs uppercase tracking-wider text-muted-foreground/70">
            {t("nav_admin")}
          </div>
          <Link
            to="/admin"
      ...
      <Link
        to="/profile"
        className="mt-2 border-t pt-2 transition hover:text-foreground"
        onClick={() => setMobileOpen(false)}
      >
        {t("nav_profile")}
      </Link>
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end" className="w-56">
                  ...
                  {roles.includes("admin") && (
                    <>
                      <DropdownMenuItem asChild>
                        <Link to="/admin/policies">Loan policies</Link>
                      </DropdownMenuItem>
                      <DropdownMenuItem asChild>
