...
const RULES: Array<[RegExp, string]> = [
  [/act on your own loan application/i, "You can't act on your own loan application — ask another officer to review it."],
  [/do not have authority for stage/i, "You don't have the required role for this stage of the loan."],
  [/cannot be marked completed while outstanding/i, "This loan still has an outstanding balance. It will complete automatically once fully repaid."],
  [/cannot be marked completed while fee/i, "This loan still has a fee balance. It will complete automatically once fully paid."],
  ...
  [/Cannot remove the last admin/i, "You can't remove the last admin — assign another admin first."],
  [/duplicate key value/i, "That value already exists. Please choose a different one."],
  [/SVG uploads are not permitted/i, "SVG files aren't allowed. Please upload a PDF, JPG, PNG, or WebP."],
  [/row-level security|permission denied|not authorized|forbidden/i, "You don't have permission to do that."],
  [/infinite recursion detected in policy/i, "Something in access control went wrong on our side. Please refresh and try again."],
  [/violates check constraint/i, "One of the values you entered isn't valid. Please review the form."],
  [/network|fetch failed|failed to fetch/i, "Network issue — please check your connection and try again."],
